export const ar = {
  ...
  landing: {
    ...
    trustLine: "بدون حساب · بدون بطاقة · ٦ أشهر مجاناً للمشتركين الجدد",
  },
  list: {
    title: "عروضي",
    new: "+ عرض جديد",
  ...
  login: {
    title: "تسجيل الدخول",
    subtitle: "احفظ عروضك وأضف هوية شركتك — مجاناً الآن.",
    google: "تسجيل الدخول بـ Google",
    hint: "لا تحتاج حساباً لإنشاء العروض. سجّل الدخول فقط للحفظ.",
    freeBadge: "🎁 ٦ أشهر مجاناً للمشتركين الجدد",
    servicesTitle: "عزّز هوية شركتك",
    servicesBody:
      "موقع بسيط أو بدون شعار؟ فريق رواق يساعدك في الهوية والتصميم والتسويق — لتبدو عروضك بمستوى شركتك.",
    servicesCta: "تعرّف على خدمات رواق ←",
  },
  services: {
    title: "خدمات رواق",
    subtitle: "هوية وتصميم وتسويق — لمن يعمل في قطاع العقار ويريد عروضاً بمستوى مكتب كبير.",
    freeNote: "اشتراك رواق: ٦ أشهر الأولى مجاناً للمشتركين الجدد.",
    items: {
      identity: {
