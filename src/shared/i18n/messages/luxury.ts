...
const ar: LuxuryMessages = {
  brand: { name: "رواق", tagline: "تصميم داخلي • إنشاءات" },
  nav: {
    home: "الرئيسية",
  ...
  pages: {
    interiorDesign: {
      title: "التصميم الداخلي",
      intro: "تصاميم داخلية فاخرة مخصصة لأكثر عملائنا تميزاً في المملكة.",
    },
    construction: {
      title: "الإنشاءات",
      intro: "إنشاءات فاخرة للفلل والقصور والمشاريع الحصرية.",
    },
    ourWork: {
      title: "أعمالنا",
      intro: "معرض منتقى من المشاريع السكنية والضيافية الفاخرة.",
    },
    about: {
      title: "عن رواق",
      intro: "حرفية وأناقة وثقة هادئة — من قلب السعودية.",
    },
    contact: {
      title: "تواصل معنا",
      intro: "ابدأ مشروعك الفاخر باستشارة خاصة.",
      formName: "الاسم",
