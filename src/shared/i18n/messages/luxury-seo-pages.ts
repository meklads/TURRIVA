    ...
    items: [
      {
        ...
        title: "Interior execution & fit-out",
        intro: "Villas, hospitality, and premium retail — technical development, materials, fabrication, and installation.",
        points: ["Shop drawings & mockups", "Modular kitchens & wardrobes", "Snagging & handover"],
        cta: "Residential execution",
        href: "/villas",
      },
      {
        slug: "exhibition-execution",
        title: "Exhibition & pavilion execution",
        intro: "Sales galleries, institutional exhibitions, and developer pavilions — coordinated with Graphics House launch assets.",
        points: ["Exhibition structures", "Joinery & décor", "Opening-ready delivery"],
        cta: "Commercial programmes",
        href: "/projects",
      },
      {
        slug: "furnishing-installation",
        title: "Furnishing & installation",
        intro: "Factory-precise modules, site coordination, and local warranty across the Gulf.",
        points: ["Laser-verified install", "SASO / SABER clearance", "After-sales support"],
...
const ar: LuxurySeoMessages = {
  ...
  servicesPage: {
    ...
    items: [
      {
        slug: "interior-execution",
        title: "التنفيذ الداخلي والتشطيب",
        intro: "فلل وضيافة وتجزئة premium — تطوير فني ومواد وتصنيع وتركيب.",
      ...
      },
      {
        ...
        intro: "معارض مبيعات ومؤسسية وبافيلions مطورين — منسّقة مع أصول إطلاق Graphics House.",
      ...
      {
        slug: "furnishing-installation",
        title: "التأثيث والتركيب",
        intro: "وحدات بدقة مصنع وتنسيق ميداني وضمان محلي في الخليج.",
        points: ["تركيب بتحقق ليزري", "SASO / SABER", "دعم ما بعد البيع"],
        cta: "ناقش مشروعك",
        href: "/contact",
      },
    ],
