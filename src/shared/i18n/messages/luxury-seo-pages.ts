...
const en: LuxurySeoMessages = {
  ...
  servicesPage: {
    title: "The work",
    intro: "Three doors, not a service menu. Start from the question that matches the job.",
    items: [
      {
        slug: "interior-execution",
        title: "Design and build",
        intro: "A residence or other interior from an idea, through to a space ready to use. One team.",
        points: ["From the brief", "Technical development", "Handover of the room"],
      ...
      },
      {
        ...
        intro: "Hotels, serviced apartments, and guest areas. An ordinary restaurant stays on commercial spaces.",
        points: ["The guest path", "Materials for daily use", "Handover ready for guests"],
        cta: "Hospitality spaces",
        href: "/hospitality-spaces",
      },
      {
        slug: "exhibition-execution",
        title: "Real estate project experience",
        intro: "The place a development meets its clients: a sales gallery, a show unit, and the fit-out around them.",
        points: ["Sales gallery", "Show unit", "A conversation, not a price list"],
      ...
      },
      {
        ...
        intro: "The design is approved. We develop it for site and build it, without replacing the designer.",
        points: ["Review of the drawings", "Joinery to the drawings", "Handover"],
      ...
      },
      {
        ...
        intro: "A restaurant, store, or showroom being fitted out now. Not shop finishing with a sign on the door.",
        points: ["How the place is used", "The brand in the room", "A space ready to open"],
        cta: "Commercial spaces",
...
const ar: LuxurySeoMessages = {
  ...
  servicesPage: {
    title: "العمل",
    intro: "ثلاثة أبواب، لا قائمة خدمات. ابدأ من السؤال الذي يطابق العمل.",
    items: [
      {
        slug: "interior-execution",
        title: "التصميم والتنفيذ",
        intro: "مسكن أو فراغ داخلي من فكرة، حتى مساحة جاهزة للاستخدام. فريق واحد.",
        points: ["من الموجز", "تطوير فني", "تسليم الغرفة"],
      ...
      },
      {
        ...
        intro: "فنادق وشقق فندقية ومناطق ضيوف. المطعم التجاري العادي يبقى في المساحات التجارية.",
        points: ["مسار الضيف", "مواد للاستخدام اليومي", "تسليم جاهز لاستقبال الضيف"],
        cta: "مساحات الضيافة",
        href: "/hospitality-spaces",
      },
      {
        ...
        intro: "المكان الذي يلتقي فيه المشروع بعملائه: مركز البيع ووحدة العرض والتجهيز حولهما.",
        points: ["مركز البيع", "وحدة العرض", "محادثة، لا قائمة أسعار"],
        cta: "تجربة المشروع",
        href: "/real-estate-experience",
      },
      {
        ...
        intro: "التصميم معتمد. نطوّره للموقع ونبنيه، من غير أن نحل محل المصمم.",
        points: ["مراجعة المخططات", "نجارة وفق المخططات", "تسليم"],
      ...
      },
      {
        ...
        intro: "مطعم أو متجر أو صالة عرض تُجهَّز الآن. ليس تشطيب محل مع لافتة على الباب.",
        points: ["كيف يُستخدم المكان", "العلامة داخل الغرفة", "مساحة جاهزة للافتتاح"],
        cta: "المساحات التجارية",
        href: "/commercial-spaces",
      },
    ],
  },
