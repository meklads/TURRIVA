...
export const en: Messages = {
 ...
 site: {
  ...
  footer: {
   ...
   sponsoredBy: "Turriva is part of",
   sponsoredByLink: "Tasami Group",
   ctaTitle: "Let's talk",
 ...
 pages: {
  ...
  about: {
   ...
   sponsoredTitle: "Part of Tasami Group",
   sponsoredBody:
    "Turriva is the group’s specialized execution company, working alongside sister companies across creative, marketing, and delivery disciplines.",
   sponsoredLink: "tasamify.com",
  },
  privacy: {
