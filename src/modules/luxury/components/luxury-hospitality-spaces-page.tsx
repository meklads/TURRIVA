...
export function LuxuryHospitalitySpacesPage({ locale }: Props) {
  ...
  return (
    <>
      <section className="lux-section lux-section--white" aria-labelledby="hospitality-spaces-title">
        <div className="lux-container grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            ...
            <h1 id="hospitality-spaces-title" className="lux-display mt-4 text-4xl leading-tight text-lux-ink md:text-5xl">
              {copy.hero.title}
            </h1>
          ...
          <div className="relative aspect-[4/5] overflow-hidden rounded-2xl shadow-lux-card sm:aspect-[5/4] lg:aspect-[4/5]">
            <Image
              ...
              alt={locale === "ar" ? "مكان يستقبل الضيف" : "A place that receives guests"}
              fill
              priority
      ...
      <section id="brief" className="lux-section lux-section--white scroll-mt-24" aria-labelledby="hospitality-spaces-cta">
        <div className="lux-container max-w-3xl">
          <h2 id="hospitality-spaces-cta" className="lux-display text-3xl leading-tight md:text-4xl">
            {copy.close.title}
          </h2>
