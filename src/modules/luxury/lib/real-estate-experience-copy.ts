...
const en: ExperienceCopy = {
  ...
  metaDescription:
    "We deliver the place where a real-estate project meets its clients: a sales gallery, a show unit, models, and fit-out. The first step is a conversation, not a price.",
  hero: {
  ...
  problem: {
    eyebrow: "The gap",
    title: "A strong project can still be hard to understand.",
    body: "Drawings, renders, and brochures help. Buyers still need a place that makes the offer clear in one visit.",
    points: [
  ...
  definition: {
    eyebrow: "The product",
    title: "The place where the project meets its clients.",
    body: "We build the sales environment around what the team must show: detailing, fit-out, fabrication, and visual tools only where they help.",
    result: "Clearer presentation for sales. A place buyers can understand and explore. No unverifiable sales claims.",
  },
  includes: {
    eyebrow: "Scope",
  ...
  scenario: {
    ...
    turriva: "Turriva handles technical development, execution, fit-out, and technology only where it explains the project.",
  ...
  form: {
    ...
    submitting: "Sending…",
    success: "We have your project details. We will review them and come back to arrange a conversation.",
...
const ar: ExperienceCopy = {
  ...
  metaDescription:
    "ننفّذ البيئة التي يستقبل فيها المشروع العقاري عملاءه: مركز البيع ووحدة العرض والمجسمات والتجهيز. الخطوة الأولى محادثة، لا سعر.",
  hero: {
  ...
  problem: {
    eyebrow: "الفجوة",
    title: "المشروع القوي قد يبقى صعب الفهم.",
    body: "المخططات والرندرات والكتيّب تساعد. لكن المشتري يحتاج مكاناً يوضح العرض في زيارة واحدة.",
    points: [
  ...
  definition: {
    eyebrow: "المنتج",
    title: "المكان الذي يلتقي فيه المشروع بعملائه.",
    body: "نبني بيئة البيع حول ما يجب أن يظهره الفريق: تفاصيل، تجهيز، تصنيع، وأدوات بصرية فقط حيث تفيد.",
    result: "عرض أوضح للمبيعات. مكان يفهمه المشتري ويستكشفه. بلا ادّعاء نتيجة بيع لا تُقاس.",
  },
  includes: {
    eyebrow: "النطاق",
  ...
  scenario: {
    ...
    turriva: "توريفا: التطوير الفني والتنفيذ والتجهيز، والتقنية فقط حيث تشرح المشروع.",
  ...
  form: {
    ...
    success: "وصلتنا تفاصيل مشروعك. سنراجعها ونتواصل لترتيب محادثة حول المشروع.",
