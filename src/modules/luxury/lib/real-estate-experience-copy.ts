...
const en: ExperienceCopy = {
  ...
  hero: {
    ...
    body: "We design and deliver the sales environment — from gallery to show unit — where your project meets its buyers.",
  ...
  definition: {
    ...
    body: "We build the sales environment around what the team must show: design, detailing, fit-out, and visual tools only where they help.",
...
const ar: ExperienceCopy = {
  ...
  hero: {
    ...
    body: "نصمّم وننفّذ بيئة البيع — من مركز البيع إلى وحدة العرض — حيث يلتقي مشروعك بالمشترين.",
    cta: "ناقش مشروعك",
  ...
  definition: {
    ...
    body: "نبني بيئة البيع حول ما يجب أن يظهره الفريق: تصميم، تفاصيل، تجهيز، وأدوات بصرية فقط حيث تفيد.",
