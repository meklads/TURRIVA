...
const en: RepositionCopy = {
  ...
  products: {
    eyebrow: "Products",
    title: "Three doors. Full capability behind them.",
    intro: "Start with the door that matches your brief. The other pages stay available as support — same team, same delivery standard.",
    frame: "We sell through three doors: the sales environment, the show unit, and fit-out. Design & build, commercial, hospitality, and renovation remain as focused support pages — not competing headlines.",
    tierPrimary: "Main doors",
    tierSecondary: "Support pages",
    learnMore: "Explore",
    primary: [
      {
    ...
    secondary: [
      {
        ...
        nameEn: "Design & Build",
        description: "From idea to a ready space — when you need design and delivery in one path.",
  ...
  album: {
    ...
    items: [
      { image: PRODUCT_IMAGES.experience, category: "Main door", title: "Where the project is shown", href: "/real-estate-experience" },
      { image: PRODUCT_IMAGES.showUnit, category: "Main door", title: "A unit the buyer walks", href: "/show-unit" },
      { image: PRODUCT_IMAGES.fitOut, category: "Main door", title: "Drawings, built", href: "/fit-out" },
      { image: PRODUCT_IMAGES.designBuild, category: "Support", title: "From idea to room", href: "/design-build" },
      { image: PRODUCT_IMAGES.commercial, category: "Support", title: "Where brand meets customer", href: "/commercial-spaces" },
      { image: PRODUCT_IMAGES.hospitality, category: "Support", title: "Where the stay begins", href: "/hospitality-spaces" },
    ],
  },
  team: {
    eyebrow: "Credibility",
...
const ar: RepositionCopy = {
  ...
  products: {
    eyebrow: "المنتجات",
    title: "ثلاثة أبواب. وخلفها كل القدرات.",
    intro: "ابدأ من الباب الذي يطابق موجزك. باقي الصفحات تبقى متاحة كدعم — نفس الفريق، ونفس معيار التسليم.",
    frame: "نبيع عبر ثلاثة أبواب: بيئة البيع، ووحدة العرض، والتنفيذ والتجهيز. التصميم والتنفيذ والتجاري والضيافة والتجديد تبقى صفحات دعم مركّزة — لا عناوين متنافسة.",
    tierPrimary: "الأبواب الرئيسية",
    tierSecondary: "صفحات الدعم",
    learnMore: "استكشف",
    primary: [
      {
        href: "/real-estate-experience",
    ...
    secondary: [
      {
        ...
        nameAr: "التصميم والتنفيذ",
        nameEn: "Design & Build",
        description: "من الفكرة إلى مساحة جاهزة — عندما تحتاجون التصميم والتنفيذ في مسار واحد.",
        image: PRODUCT_IMAGES.designBuild,
      },
      {
        href: "/commercial-spaces",
  ...
  album: {
    ...
    items: [
      { image: PRODUCT_IMAGES.experience, category: "باب رئيسي", title: "حيث يُعرض المشروع", href: "/real-estate-experience" },
      { image: PRODUCT_IMAGES.showUnit, category: "باب رئيسي", title: "وحدة يمشي فيها المشتري", href: "/show-unit" },
      { image: PRODUCT_IMAGES.fitOut, category: "باب رئيسي", title: "مخططات تُبنى", href: "/fit-out" },
      { image: PRODUCT_IMAGES.designBuild, category: "دعم", title: "من فكرة إلى غرفة", href: "/design-build" },
      { image: PRODUCT_IMAGES.commercial, category: "دعم", title: "حيث تلتقي العلامة بالعميل", href: "/commercial-spaces" },
      { image: PRODUCT_IMAGES.hospitality, category: "دعم", title: "حيث تبدأ الإقامة", href: "/hospitality-spaces" },
    ],
  },
  team: {
    eyebrow: "المصداقية",
