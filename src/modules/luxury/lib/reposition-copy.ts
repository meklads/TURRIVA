    ...
    primary: [
      {
        ...
        description: "Where buyers visit the project every day.",
      ...
      },
      {
        ...
        nameAr: "وحدة العرض",
        nameEn: "Show unit",
        description: "A villa or apartment the buyer walks through.",
    ...
    secondary: [
      {
        ...
        description: "We start before an approved design exists.",
      ...
      },
      {
        ...
        nameAr: "تجاري",
        nameEn: "Commercial",
        description: "Store, restaurant, or office for daily use.",
      ...
      },
      {
        ...
        nameAr: "ضيافة",
        nameEn: "Hospitality",
        description: "Hotel, serviced apartments, or guest lobby.",
      ...
      },
      {
        ...
        nameAr: "تجديد",
        nameEn: "Renovation",
        description: "An existing space: what stays and what changes.",
    ...
    primary: [
      {
        ...
        nameAr: "صالة البيع",
        nameEn: "Sales gallery",
        description: "المشتري يزور المشروع هنا يومياً.",
        image: PRODUCT_IMAGES.experience,
      },
      {
        href: "/show-unit",
        nameAr: "وحدة العرض",
        nameEn: "Show unit",
        description: "فيلا أو شقة يمشي فيها المشتري.",
        image: PRODUCT_IMAGES.showUnit,
      },
    ],
    secondary: [
      {
        ...
        nameAr: "من فكرة إلى تسليم",
        nameEn: "Idea to handover",
        description: "نبدأ قبل وجود تصميم معتمد.",
        image: PRODUCT_IMAGES.designBuild,
      },
      {
        href: "/fit-out",
      ...
      },
      {
        ...
        nameAr: "تجاري",
        nameEn: "Commercial",
        description: "متجر أو مطعم أو مكتب يعمل يومياً.",
        image: PRODUCT_IMAGES.commercial,
      },
      {
        href: "/hospitality-spaces",
        nameAr: "ضيافة",
        nameEn: "Hospitality",
        description: "فندق أو شقق فندقية أو ردهة ضيوف.",
        image: PRODUCT_IMAGES.hospitality,
      },
      {
        href: "/renovation",
        nameAr: "تجديد",
        nameEn: "Renovation",
        description: "مساحة قائمة: ما يبقى وما يتغير.",
        image: PRODUCT_IMAGES.renovation,
      },
    ],
  },
