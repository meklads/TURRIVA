...
const en: RepositionCopy = {
  ...
  products: {
    ...
    frame: "We begin with sales-environment décor and the marketing show unit. Broader interiors follow when the project expands.",
    ...
    primary: [
      {
        ...
        description: "Sales-gallery décor, show unit, presentation, and fit-out — scoped to your launch.",
      ...
      },
      {
        ...
        nameAr: "وحدة العرض",
        nameEn: "Show Unit",
        description: "Show-villa or apartment décor the buyer can walk. The lifestyle made physical.",
    ...
    secondary: [
      {
        ...
        nameEn: "Design & Décor",
        description: "From idea to finished décor: design, detailing, supply, install, handover.",
      ...
      },
      {
        ...
        description: "Your approved design. Our décor execution. We build. We do not replace the designer.",
      ...
      },
      {
        ...
        description: "Retail, dining, and showroom décor that carries the brand and works every day.",
      ...
      },
      {
        ...
        description: "Refresh existing décor — what stays, what changes. Assessed before work begins.",
...
const ar: RepositionCopy = {
  ...
  products: {
    ...
    frame: "نبدأ من ديكور بيئة البيع ووحدة العيّنة التسويقية. وتتسع المساحات الأخرى حين يتسع المشروع.",
    ...
    primary: [
      {
        ...
        nameAr: "ديكور بيئة البيع",
        nameEn: "Sales Environment Décor",
        description: "ديكور وتنفيذ صالة البيع ووحدة العرض والعرض — وفق مرحلة إطلاقكم.",
        image: PRODUCT_IMAGES.experience,
      },
      {
        href: "/show-unit",
        nameAr: "وحدة العرض",
        nameEn: "Show Unit",
        description: "ديكور فيلا أو شقة أو جناح يمشي فيه المشتري. أسلوب الحياة وقد صار مكاناً.",
        image: PRODUCT_IMAGES.showUnit,
      },
    ],
    secondary: [
      {
        ...
        nameAr: "التصميم والديكور",
        nameEn: "Design & Décor",
        description: "من الفكرة إلى ديكور جاهز: تصميم، تفاصيل، توريد، تركيب، تسليم.",
        image: PRODUCT_IMAGES.designBuild,
      },
      {
        href: "/fit-out",
        nameAr: "الديكور والتنفيذ",
        nameEn: "Décor & Fit-Out",
        description: "تصميمكم المعتمد. ننفّذ الديكور ونبني — ولا نحل محل المصمم.",
        image: PRODUCT_IMAGES.fitOut,
      },
      {
        href: "/commercial-spaces",
        nameAr: "المساحات التجارية",
        nameEn: "Commercial Spaces",
        description: "ديكور تجزئة ومطاعم وصالات عرض تحمل العلامة وتعمل يومياً.",
        image: PRODUCT_IMAGES.commercial,
      },
      {
        href: "/hospitality-spaces",
      ...
      },
      {
        ...
        nameAr: "التجديد والتطوير",
        nameEn: "Renovation & Upgrade",
        description: "تجديد ديكور مساحة قائمة — ما يبقى وما يتغير، يُحدَّد قبل بدء العمل.",
        image: PRODUCT_IMAGES.renovation,
      },
    ],
  },
