...
const en: RepositionCopy = {
  ...
  definition: {
    ...
    title: "Sales environments first. Delivery to one standard.",
    body: "Turriva designs and delivers the places where real-estate projects are presented and understood: sales galleries, marketing show units, and launch exhibitions. The same team extends that craft to hospitality, private residences, and commercial interiors when the brief asks for it. Creative layers from Graphics House join the spatial work when they serve the launch.",
    audiences: "Sales galleries · Show units · Hospitality · Residences · Retail",
  ...
  developers: {
    ...
    title: "When the project is ready to sell, the place of sale must be ready too.",
    intro:
      "Buyers need a composed setting in which the development becomes tangible. We design and deliver that setting: the gallery, the sample unit, and the supporting experience when it clarifies the story.",
    points: [
      {
      ...
      {
        title: "Execution, with experience tools as needed",
        body: "Screens and models serve the room. The space remains the product.",
...
const ar: RepositionCopy = {
  ...
  definition: {
    ...
    title: "بيئة البيع أولاً. والتنفيذ بمعيار واحد.",
    body: "توريفا تصمم وتنفّذ الأماكن التي يُعرض فيها المشروع العقاري ويُفهم: صالات البيع، ووحدات العيّنة التسويقية، ومعارض الإطلاق. ويمتد العمل ذاته إلى الضيافة والمساكن الخاصة والمحلات حين يطلب الموجز ذلك. الطبقة الإبداعية من جرافيكس هاوس تُستدعى عندما تخدم الإطلاق.",
    audiences: "صالات بيع · وحدات عرض · ضيافة · سكني فاخر · تجاري",
    image: "/brand/turriva/sections/definition-spaces.jpg",
    imageAlt: "مساحة داخلية فاخرة جاهزة. مصمّمة ومفروشة وجاهزة للعرض",
  },
  developers: {
    eyebrow: "للمطورين",
    title: "حين يكون المشروع جاهزاً للبيع، يجب أن يكون مكان البيع جاهزاً أيضاً.",
    intro:
      "المشتري يحتاج بيئة مرتّبة يتحوّل فيها المشروع إلى تجربة ملموسة. نصمم وننفّذ هذه البيئة: مركز البيع، ووحدة العيّنة، وأدوات التجربة حين توضح الحكاية.",
    points: [
      {
      ...
      },
      {
        ...
        body: "الشاشات والمجسمات تخدم المكان. والمكان يبقى هو المنتج.",
        image: "/brand/turriva/sections/dev-experience-tools.jpg",
