...
const en: RepositionCopy = {
  ...
  products: {
    ...
    frame: "We begin with design and build of sales-environment décor and the marketing show unit. Broader interiors follow when the project expands.",
    ...
    primary: [
      {
        ...
        description: "Design and build of sales-gallery décor, show unit, and presentation — scoped to your launch.",
      ...
      },
      {
        ...
        nameAr: "وحدة العرض",
        nameEn: "Show Unit",
        description: "Design and build of show-villa or apartment décor the buyer can walk. The lifestyle made physical.",
    ...
    secondary: [
      ...
      },
      {
        ...
        description: "We design the décor and build it — from concept to ready handover.",
      ...
      },
      {
        ...
        description: "Design and build of retail, dining, and showroom décor that carries the brand and works every day.",
      ...
      },
      {
        ...
        description: "Design and build of décor refresh — what stays, what changes. Assessed before work begins.",
...
const ar: RepositionCopy = {
  ...
  developers: {
    ...
    cta: "ناقش مشروعك",
    fitOutCta: "تصميم وتنفيذ الديكور",
    pageCta: "ناقش مشروعك",
  },
  products: {
    eyebrow: "المنتجات",
    ...
    frame: "نبدأ من تصميم وتنفيذ ديكور بيئة البيع ووحدة العيّنة التسويقية. وتتسع المساحات الأخرى حين يتسع المشروع.",
    ...
    primary: [
      {
        ...
        nameAr: "تصميم وتنفيذ ديكور البيع",
        nameEn: "Sales Décor Design & Build",
        description: "تصميم وتنفيذ ديكور صالة البيع ووحدة العرض والعرض — وفق مرحلة إطلاقكم.",
        image: PRODUCT_IMAGES.experience,
      },
      {
        href: "/show-unit",
        nameAr: "وحدة العرض",
        nameEn: "Show Unit",
        description: "تصميم وتنفيذ ديكور فيلا أو شقة أو جناح يمشي فيه المشتري. أسلوب الحياة وقد صار مكاناً.",
        image: PRODUCT_IMAGES.showUnit,
      },
    ],
    secondary: [
      ...
      },
      {
        ...
        nameAr: "تصميم وتنفيذ الديكور",
        nameEn: "Décor Design & Build",
        description: "نصمم الديكور وننفّذه — من التصور إلى التسليم الجاهز.",
        image: PRODUCT_IMAGES.fitOut,
      },
      {
        href: "/commercial-spaces",
        nameAr: "المساحات التجارية",
        nameEn: "Commercial Spaces",
        description: "تصميم وتنفيذ ديكور تجزئة ومطاعم وصالات عرض تحمل العلامة وتعمل يومياً.",
        image: PRODUCT_IMAGES.commercial,
      },
      {
        href: "/hospitality-spaces",
      ...
      },
      {
        ...
        nameAr: "التجديد والتطوير",
        nameEn: "Renovation & Upgrade",
        description: "تصميم وتنفيذ تجديد ديكور مساحة قائمة — ما يبقى وما يتغير، يُحدَّد قبل بدء العمل.",
        image: PRODUCT_IMAGES.renovation,
      },
    ],
  },
