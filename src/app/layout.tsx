...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    icons: {
      icon: [
        { url: "/brand/turriva/favicon-32.png", sizes: "32x32", type: "image/png" },
        { url: "/brand/turriva/icon-512.png", sizes: "512x512", type: "image/png" },
      ],
      apple: [{ url: "/brand/turriva/apple-touch-icon.png", sizes: "180x180", type: "image/png" }],
    },
    ...(googleVerification
