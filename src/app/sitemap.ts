...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    { path: "/show-unit", priority: 0.97, changeFrequency: "weekly" as const },
    { path: "/fit-out", priority: 0.96, changeFrequency: "weekly" as const },
    { path: "/design-build", priority: 0.88, changeFrequency: "weekly" as const },
    { path: "/commercial-spaces", priority: 0.86, changeFrequency: "weekly" as const },
    { path: "/hospitality-spaces", priority: 0.84, changeFrequency: "weekly" as const },
    { path: "/renovation", priority: 0.82, changeFrequency: "weekly" as const },
    ...
    LOCALES.map((locale) => ({
      ...
      alternates: {
        languages: {
          ...
          "x-default": `${TURRIVA_PUBLIC_URL}${localizePath(route.path, "en")}`,
        },
      },
    }))
  );
