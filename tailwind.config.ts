  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "lux-soft": "0 8px 40px rgba(90, 70, 45, 0.1)",
        "lux-card": "0 2px 12px rgba(90, 70, 45, 0.06), 0 12px 32px rgba(42, 36, 28, 0.05)",
        "lux-glow": "0 0 48px rgba(232, 184, 74, 0.22), 0 12px 32px rgba(26, 26, 26, 0.12)",
      },
      letterSpacing: {
        display: "-0.025em",
      },
